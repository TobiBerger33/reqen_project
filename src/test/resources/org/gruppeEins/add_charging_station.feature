Feature: add charging point
  ...
  Scenario: Add a new charging point to an existing location
    Given a location with identifier 1000 exists in the system
    When I add charging station with identifier 101 to that location
  ...
  Scenario: Attempt to add a charging point with a duplicate identifier
    Given a location with identifier 2000 exists with a station with identifier 202 in the system
    When I try to add another charging point with identifier 202 to the same location
